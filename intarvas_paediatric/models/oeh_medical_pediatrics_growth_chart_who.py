...
class intarvasPediatricsNewBorn(models.Model):
    ...
    indicator = fields.Selection(INDICATOR, string='Indicator', required=True, tracking=True)
    measure = fields.Selection(MEASURE, string='Measure', required=True, tracking=True)
    sex = fields.Selection(SEX, string='Sex', tracking=True)
    month = fields.Integer(string='Month', tracking=True)
    type = fields.Char(string='Type', size=56, tracking=True)

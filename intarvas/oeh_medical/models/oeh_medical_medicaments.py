...
# Medicines
class intarvasMedicines(models.Model):
    ...
    def create(self, vals_list):
        medicines = super(intarvasMedicines, self).create(vals_list)
        for medicine in medicines:
            medicine.type = 'consu'
            medicine.is_storable = True
        return medicines


class intarvasDoseUnit(models.Model):
...
class intarvasDrugRoute(models.Model):
...
class intarvasDrugForm(models.Model):
...
class intarvasDosage (models.Model):

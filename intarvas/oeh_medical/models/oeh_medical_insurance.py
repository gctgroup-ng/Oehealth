...
class intarvasInsuranceType(models.Model):
...
class intarvasInsurance(models.Model):
    ...
    def create(self, vals):
        ...
        insurance = super(intarvasInsurance, self).create(vals)
        return insurance
    ...
    def unlink(self):
        ...
        return super(intarvasInsurance, self).unlink()

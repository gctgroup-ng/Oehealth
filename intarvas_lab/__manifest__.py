...
##############################################################################
{
    'name': 'intarvAS: Laboratory Information System',
    'version': "19.0.0.0",
    ...
    'data': [
        ...
        'security/oeh_lab_menu_right.xml',
        ...
        'views/oeh_lab_test_templates_view.xml',
        'data/oeh_lab_test_templates.xml',
        'security/ir.model.access.csv',

    ],
    'assets': {
        'web.assets_backend': [
            'intarvas_lab/static/src/fields/result_indicator.js',
            'intarvas_lab/static/src/fields/result_indicator.xml',
            'intarvas_lab/static/src/fields/result_indicator.css',
        ],
    },
    'auto_install': False,
}
